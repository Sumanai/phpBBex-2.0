...
$lang = array_merge($lang, array(
	...
	'FORUM_ICON_REPLACE'				=> 'Change the icon forum',
	'FORUM_ICON_REPLACE_EXPLAIN'		=> 'It allows the forum image to replace the standard icon.',
	'FORUM_IMAGE'						=> 'Forum image',
	'FORUM_IMAGE_EXPLAIN'				=> 'Location, relative to the phpBBex root directory, of an additional image to associate with this forum.',
	'FORUM_IMAGE_NO_EXIST'				=> 'The specified forum image does not exist',
	'FORUM_LINK_EXPLAIN'				=> 'Full URL (including the protocol, i.e.: <samp>http://</samp>) to the destination location that clicking this forum will take the user, e.g.: <samp>http://www.phpbbex.com/</samp>.',
