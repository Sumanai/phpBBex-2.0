...
$lang = array_merge($lang, array(
	...
	'DL_CONFIG_EXPLAIN'			=> 'Вы можете целиком скачать файл config.php к себе на компьютер. Затем вам будет нужно вручную закачать этот файл в корневую папку phpBBex, заменив исходный config.php. Помните, что файл должен быть закачан на сервер в формате ASCII (если вы не знаете как этого добиться, обратитесь к документации вашего FTP-клиента). После того, как закачаете config.php, щелкните «Готово» для перехода к следующему шагу.',
	'DL_DOWNLOAD'				=> 'Скачать',
	'DONE'						=> 'Готово',
	...
	'FILES_REQUIRED_EXPLAIN'	=> 'Для правильной работы phpBBex <strong>необходим</strong> доступ на чтение или запись определённых файлов и папок. Если вы увидите надпись «Не найден», то необходимо создать соответствующий файл или папку. А если увидите надпись «Нет прав на запись», то необходимо изменить права на файл или на папку, чтобы разрешить phpBBex запись в них.',
	...
	'FORUM_PATH_EXPLAIN'		=> '<strong>Относительный</strong> путь к старой конференции от <strong>корневой папки установленного phpBBex</strong>.',
	'FOUND'						=> 'Найден',
	...
	'FTP_PATH'					=> 'Путь FTP',
	'FTP_PATH_EXPLAIN'			=> 'Путь от корневой папки FTP до корневой папки phpBBex, например, <samp>htdocs/phpBBex/</samp>',
	'FTP_UPLOAD'				=> 'Закачать',
	...
	<p>Для установки phpBBex вам понадобятся следующие реквизиты доступка к базе данных MySQL:
	<ul>
	...
	'SCRIPT_PATH_EXPLAIN'		=> 'Путь к папке, содержащей phpBBex, относительно корня сайта. Например, <samp>/phpBBex</samp>.',
