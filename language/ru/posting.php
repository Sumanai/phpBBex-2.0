...
$lang = array_merge($lang, array(
	...
	'ATTACH_QUOTA_REACHED'		=> 'Достигнут максимальный общий размер вложений на форуме.',
	...
	'BBCODE_L_HELP'				=> 'Список: [list]список[/list] или [list=1]список[/list]',
	'BBCODE_L_HELP_CTRL'				=> 'держите ctrl для ввода стартового значения нумерованного списка',
	'BBCODE_O_HELP'				=> 'Упорядоченный список: [list=1][*]Пункт первый[/list] или [list=a][*]Пункт a[/list]',
	'BBCODE_LISTITEM_HELP'		=> 'Элемент списка: [*]',
	'BBCODE_LISTITEM_HELP_EX'		=> 'Элемент списка: [*] (выделите текст для автоматической вставки в каждую строку)',
	'BBCODE_P_HELP'				=> 'Вставить изображение: [img]http://image_url[/img]',
	'BBCODE_Q_HELP'				=> 'Цитата: [quote]текст[/quote] или [quote=&quot;имя&quot;]текст[/quote]',
	'BBCODE_Q_HELP_CTRL'				=> 'держите ctrl для ввода имени цитируемого',
	'BBCODE_S_HELP'				=> 'Цвет шрифта: [color=red]текст[/color] или [color=#FF0000]текст[/color]',
	'BBCODE_SPOILER_HELP'		=> 'Скрытый текст: [spoiler]текст[/spoiler] или [spoiler=&quot;заголовок&quot;]текст[/spoiler]',
	'BBCODE_SPOILER_HELP_CTRL'		=> 'держите ctrl для ввода заголовка',
	'BBCODE_STRIKE_HELP'		=> 'Зачёркнутый текст: [s]текст[/s]',
	'BBCODE_TT_HELP'			=> 'Моноширный текст: [tt]текст[/tt]',
	...
	'CANNOT_POST_STICKY'		=> 'Вы не можете создавать прикреплённые темы.',
	...
	'ENTER_QUOTE_NAME'			=> 'Введите имя цитируемого',
	'ENTER_LIST_START'			=> 'Введите начальное значение',
	...
	'LOAD_DRAFT_EXPLAIN'		=> 'Вы можете выбрать черновик для продолжения редактирования сообщения. Ваше текущее сообщение будет удалено, содержание сообщения будет утеряно. <br />Просматривать, редактировать и удалять черновики вы можете в вашей личной панели управления.',
	'LOGIN_EXPLAIN_BUMP'		=> 'Вам необходимо авторизоваться для поднятия темы в этом разделе.',
	'LOGIN_EXPLAIN_DELETE'		=> 'Вам необходимо авторизоваться для удаления сообщений в этом разделе.',
	'LOGIN_EXPLAIN_POST'		=> 'Вам необходимо авторизоваться для создания сообщений в этом разделе.',
	'LOGIN_EXPLAIN_QUOTE'		=> 'Вам необходимо авторизоваться для цитирования сообщений в этом разделе.',
	'LOGIN_EXPLAIN_REPLY'		=> 'Вам необходимо авторизоваться, чтобы отвечать в темах в этом разделе.',
	...
	'MAX_FLASH_HEIGHT_EXCEEDED'	=> 'Ваши флэш-файлы должны быть не более %d пикс. в высоту.',
	'MAX_FLASH_WIDTH_EXCEEDED'	=> 'Ваши флэш-файлы должны быть не более %d пикс. в ширину.',
	'MAX_IMG_HEIGHT_EXCEEDED'	=> 'Ваши изображения должны быть не более %1$d пикс. в высоту.',
	'MAX_IMG_WIDTH_EXCEEDED'	=> 'Ваши изображения должны быть не более %d пикс. в ширину.',
	...
	'NO_DELETE_POLL_OPTIONS'	=> 'Вы не можете удалять существующие варианты ответов без обнуления текущих результатов.',
	...
	'POLL_RESET'				=> 'Обнулить результаты опроса',
	...
	'POLL_OPTIONS_EXPLAIN'		=> 'Разместите каждый вариант ответа с новой строки. Максимальное количество вариантов: <strong>%d</strong>.',
	'POLL_OPTIONS_EDIT_EXPLAIN'	=> 'Разместите каждый вариант ответа с новой строки. Максимальное количество вариантов: <strong>%d</strong>. При удалении вариантов ответа вы должны обнулить результаты опроса.',
	...
	'POST_CONFIRM_EXPLAIN'		=> 'Для предотвращения автоматического размещения сообщений на этом форуме необходимо ввести код подтверждения. Код отображён на картинке ниже. Если из-за плохого зрения или по другим причинам вы не можете прочесть код на картинке, свяжитесь с %sадминистратором%s',
	'POST_DELETED'				=> 'Сообщение успешно удалено.',
	'POST_EDITED'				=> 'Сообщение успешно отредактировано.',
	'POST_EDITED_MOD'			=> 'Сообщение успешно отредактировано, но должно быть одобрено модератором до того, как будет отображено на форуме.',
	'POST_GLOBAL'				=> 'Глобальное объявление',
	'POST_ICON'					=> 'Значок',
	'POST_NORMAL'				=> 'Обычная',
	...
	'POST_STORED_MOD'			=> 'Сообщение успешно отправлено, но должно быть одобрено модератором до того, как будет отображено на форуме.',
	'POST_TOPIC_AS'				=> 'Статус темы',
	'PROGRESS_BAR'				=> 'Индикатор загрузки',

	'QUOTE_DEPTH_EXCEEDED'		=> 'Максимально допустимое количество вложенных друг в друга цитат: %d.',
	'SPOILER_DEPTH_EXCEEDED'		=> 'Максимально допустимое количество вложенных друг в друга спойлеров: %d.',
	'QUOTE_NO_NESTING'			=> 'Вложенные цитаты запрещены.',
	'SPOILER_NO_NESTING'			=> 'Вложенные спойлеры запрещены.',
	...
	'STICKY_ANNOUNCE_TIME_LIMIT'=> 'Срок для объявления/прикреплённой темы',
	'STICK_TOPIC_FOR'			=> 'Срок',
	'STICK_TOPIC_FOR_EXPLAIN'	=> '<i>(относительно даты публикации, введите 0 для снятия ограничений)</i>',
	...
	'TOO_MANY_CHARS_LIMIT'		=> 'Максимальное разрешённое количество символов: %1$d.',
	...
	'TOPIC_PRIORITY'			=> 'Приоритет темы',
	'TOPIC_PRIORITY_EXPLAIN'	=> '<i>(темы с большим приоритетом выводятся выше других)</i>',

	'UNAUTHORISED_BBCODE'		=> 'Вы не можете использовать некоторые BBCode: %s.',
	'UNGLOBALISE_EXPLAIN'		=> 'Для того, чтобы изменить статус темы с важной на обычную, вы должны выбрать раздел, в котором она будет опубликована.',
	...
	'USER_CANNOT_BUMP'			=> 'Вы не можете поднимать темы в этом разделе.',
	'USER_CANNOT_DELETE'		=> 'Вы не можете удалять сообщения в этом разделе.',
	'USER_CANNOT_EDIT'			=> 'Вы не можете редактировать сообщения в этом разделе.',
	'USER_CANNOT_REPLY'			=> 'Вы не можете отвечать на сообщения в этом разделе.',
	'USER_CANNOT_FORUM_POST'	=> 'Вы не можете размещать сообщения в этом разделе. Тип форума не поддерживает этого.',
