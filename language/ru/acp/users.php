...
$lang = array_merge($lang, array(
	...
	'AT_LEAST_ONE_FOUNDER'	=> 'Вы не можете понизить статус этого основателя до обычного пользователя. На форуме должен быть по крайней мере один основатель. Если вы хотите изменить статус основателя для этого пользователя, то сначала сделайте основателем другого пользователя.',
	...
	'CANNOT_BAN_ANONYMOUS'	=> 'Вы не можете закрыть доступ анонимному пользователю. Права доступа для гостей могут быть заданы на соответствующей вкладке панели администратора.',
	...
	'MOVE_POSTS_EXPLAIN'	=> 'Выберите раздел форума, в который вы хотите переместить все сообщения данного пользователя.',
	...
	'USER_POSTS_MOVED'				=> 'Сообщения пользователя успешно перемещены в указанный раздел.',
