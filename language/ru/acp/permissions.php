...
$lang = array_merge($lang, array(
	'ACP_PERMISSIONS_EXPLAIN'	=> '
		...
		<p>Для получения более подробной информации по настройке и управлению правами доступа на вашем форуме phpBBex смотрите <a href="http://www.phpbbguru.net/documentation/admin/permissions/">Раздел 3.7 руководства phpBB</a>.</p>
	',
	...
	'ROLE_DESCRIPTION_FORUM_FULL'			=> 'Доступ к использованию всех возможностей в разделе, включая создание объявлений и прикреплённых тем. Также доступна возможность игнорирования флуд-интервала. Не рекомендуется для обычных пользователей.',
	'ROLE_DESCRIPTION_FORUM_LIMITED'		=> 'Доступ к обычным возможностям в разделе, за исключением прикрепления вложений или использования значков сообщений.',
	...
	'ROLE_DESCRIPTION_FORUM_ONQUEUE'		=> 'Доступ к большинству возможностей на разделе, включая прикрепление вложений, но размещаемые сообщения и темы требуют предварительного одобрения модератором.',
	'ROLE_DESCRIPTION_FORUM_POLLS'			=> 'Аналогично стандартному доступу, но с возможностью создания опросов.',
	'ROLE_DESCRIPTION_FORUM_READONLY'		=> 'Имеет доступ к чтению раздела, но без возможности создавать новые темы или отвечать на сообщения.',
	...
	'TRACE_GROUP_NEVER_TOTAL_NEVER_LOCAL'	=> 'Значение права группы для этого раздела <strong>НИКОГДА</strong> соответствует результирующему, поэтому сохранено ранее заданное значение.',
	...
	'TRACE_GROUP_NEVER_TOTAL_NO_LOCAL'	=> 'Значение права группы для этого раздела <strong>НИКОГДА</strong> становится новым результирующим, так как ранее не было задано (было задано <strong>НЕТ</strong>).',
	...
	'TRACE_GROUP_NEVER_TOTAL_YES_LOCAL'	=> 'Значение права группы для этого раздела <strong>НИКОГДА</strong> заменяет результирующее <strong>ДА</strong> на <strong>НИКОГДА</strong> для этого пользователя.',
	'TRACE_GROUP_NO'				=> 'Значение права для этой группы <strong>НЕТ</strong>, поэтому сохранено ранее заданное результирующее право.',
	'TRACE_GROUP_NO_LOCAL'			=> 'Значение права для этой группы в этом разделе <strong>НЕТ</strong>, поэтому сохранено ранее заданное значение.',
	...
	'TRACE_GROUP_YES_TOTAL_NEVER_LOCAL'	=> 'Значение права группы для этого раздела <strong>ДА</strong>, но результирующее право <strong>НИКОГДА</strong> не может быть заменено.',
	...
	'TRACE_GROUP_YES_TOTAL_NO_LOCAL'	=> 'Значение права группы для этого раздела <strong>ДА</strong> становится новым результирующим, так как ранее не было задано (было задано <strong>НЕТ</strong>).',
	...
	'TRACE_GROUP_YES_TOTAL_YES_LOCAL'	=> 'Значение права группы для этого раздела <strong>ДА</strong>, результирующим правом также является <strong>ДА</strong>, поэтому сохранено ранее заданное значение.',
	'TRACE_PERMISSION'				=> 'Отследить право доступа — %s',
	'TRACE_RESULT'					=> 'Отследить результат',
	'TRACE_SETTING'					=> 'Отследить настройки',

	'TRACE_USER_GLOBAL_YES_TOTAL_YES'		=> 'Независимо от раздела значение права этого пользователя <strong>ДА</strong>, результирующее право также равно <strong>ДА</strong>, таким образом, сохранено результирующее значение. %sОтследить глобальное право%s',
	'TRACE_USER_GLOBAL_YES_TOTAL_NEVER'		=> 'Независимо от раздела значение права для этого пользователя <strong>ДА</strong>, которое заменяет текущее локальное значение <strong>НИКОГДА</strong>. %sОтследить глобальное право%s',
	'TRACE_USER_GLOBAL_NEVER_TOTAL_KEPT'	=> 'Независимо от раздела значение права этого пользователя <strong>НИКОГДА</strong>, которое не влияет на локальное значение. %sОтследить глобальное право%s',

	'TRACE_USER_FOUNDER'					=> 'Пользователь является основателем форума, поэтому значения администраторских прав всегда установлены в значение <strong>ДА</strong>.',
	...
	'TRACE_USER_KEPT_LOCAL'					=> 'Значение права для этого пользователя на данном разделе <strong>НЕТ</strong>, таким образом, сохранено ранее заданное результирующее значение.',
	...
	'TRACE_USER_NEVER_TOTAL_NEVER_LOCAL'	=> 'Значение права для этого пользователя на данном разделе <strong>НИКОГДА</strong>, результирующим правом также является <strong>НИКОГДА</strong>, поэтому изменения не производятся.',
	...
	'TRACE_USER_NEVER_TOTAL_NO_LOCAL'		=> 'Значение права для этого пользователя на данном разделе <strong>НИКОГДА</strong> становится новым результирующим правом, так как ранее было задано <strong>НЕТ</strong>.',
	...
	'TRACE_USER_NEVER_TOTAL_YES_LOCAL'		=> 'Значение права для этого пользователя на данном разделе <strong>НИКОГДА</strong> заменяет ранее заданное значение <strong>ДА</strong>.',
	...
	'TRACE_USER_NO_TOTAL_NO_LOCAL'			=> 'Значение права для этого пользователя в данном разделе <strong>НЕТ</strong>, результирующим правом также является <strong>НЕТ</strong>, поэтому установлено значение по умолчанию <strong>НИКОГДА</strong>.',
	...
	'TRACE_USER_YES_TOTAL_NEVER_LOCAL'		=> 'Значение права для этого пользователя в данном разделе <strong>ДА</strong>, но результирующе право <strong>НИКОГДА</strong> не может быть заменено.',
	...
	'TRACE_USER_YES_TOTAL_NO_LOCAL'			=> 'Значение права для этого пользователя в данном разделе <strong>ДА</strong> становится новым результирующим правом, так как ранее было задано <strong>НЕТ</strong>.',
	...
	'TRACE_USER_YES_TOTAL_YES_LOCAL'		=> 'Значение права для этого пользователя в данном разделе <strong>ДА</strong>, результирующим правом также является <strong>ДА</strong>, поэтому изменения не производятся.',
