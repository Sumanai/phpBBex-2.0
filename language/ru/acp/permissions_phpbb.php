...
// User Permissions
$lang = array_merge($lang, array(
	'ACL_U_VIEWPROFILE'	=> 'Может просматривать профили, список пользователей и страницу «Кто сейчас на форуме»',
	...
	'ACL_U_IGNOREFPEDITTIME'	=> 'Может игнорировать ограничение времени на редактирование первого сообщения',
	'ACL_U_IGNOREEDITTIME'		=> 'Может игнорировать ограничение времени на редактирование всех сообщений',
	...
	'ACL_U_CANPLUS'		=> 'Может ставить положительные оценки',
	'ACL_U_CANMINUS'	=> 'Может ставить отрицательные оценки',
...
// Forum Permissions
$lang = array_merge($lang, array(
	'ACL_F_LIST'		=> 'Может видеть раздел',
	'ACL_F_READ'		=> 'Может читать раздел',
	'ACL_F_SEARCH'		=> 'Может использовать поиск в разделе',
	'ACL_F_SUBSCRIBE'	=> 'Может подписываться на раздел',
	...
	'ACL_F_STICKY'		=> 'Может прикреплять темы',
...
$lang = array_merge($lang, array(
	...
	'ACL_M_WARN'		=> 'Может объявлять предупреждения<br /><em>Это право может быть назначено только глобально, а не на уровне разделов.</em>', // This moderator setting is only global (and not local)
	'ACL_M_PM_REPORT'	=> 'Может закрывать и удалять жалобы на личные сообщения<br /><em>Это право может быть назначено только глобально, а не на уровне разделов.</em>', // This moderator setting is only global (and not local)
	'ACL_M_BAN'			=> 'Может управлять блокировкой<br /><em>Это право может быть назначено только глобально, а не на уровне разделов.</em>', // This moderator setting is only global (and not local)
));

// Admin Permissions
$lang = array_merge($lang, array(
	'ACL_A_BOARD'		=> 'Может изменять настройки форума и проверять обновления',
	...
	'ACL_A_FORUM'		=> 'Может управлять разделами',
	'ACL_A_FORUMADD'	=> 'Может создавать разделы',
	'ACL_A_FORUMDEL'	=> 'Может удалять разделы',
	'ACL_A_PRUNE'		=> 'Может очищать разделы',
	...
	'ACL_A_USER'		=> 'Может управлять пользователями<br /><em>Право также включает просмотр типа браузера пользователей в списке находящихся на форуме.</em>',
	...
	'ACL_A_FAUTH'		=> 'Может изменять права доступа для разделов',
