...
$lang = array_merge($lang, array(
	...
	'EXTENSION_NOT_AVAILABLE'	=> 'Выбранное расширение недоступно для данного форума. Проверьте, являются ли используемые на форуме версии phpBB и PHP совместимыми с этим расширением (см. подробности на странице информации).',
	...
	'EXTENSION_ENABLE_EXPLAIN'		=> 'Включение этого расширения позволяет использовать его на форуме.',
