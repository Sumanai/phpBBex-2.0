...
$lang = array_merge($lang, array(
	...
	'ALLOWED_FORUMS'					=> 'Разрешить в разделах',
	'ALLOWED_FORUMS_EXPLAIN'			=> 'Возможность публикации назначенных расширений в выбранных (или во всех) разделах.',
	'ALLOWED_IN_PM_POST'				=> 'Группа расширений разрешена',
	'ALLOW_ATTACHMENTS'					=> 'Разрешить вложения',
	'ALLOW_ALL_FORUMS'					=> 'Во всех разделах',
	...
	'NO_UPLOAD_DIR'				=> 'Указанный вами каталог для загрузки файлов не существует.',
	'NO_WRITE_UPLOAD'			=> 'Указанный вами каталог для загрузки файлов недоступен для записи. Измените права доступа для этого каталога, разрешив серверу запись в него.',
	...
	'UPLOAD_DENIED_FORUM'			=> 'У вас нет прав на загрузку файлов в раздел «%s».',
	'UPLOAD_DIR'					=> 'Каталог для хранения вложений',
	'UPLOAD_DIR_EXPLAIN'			=> 'Примечание: если вы измените этот каталог, в то время как в нём уже имеются загруженные файлы, то вам придётся вручную скопировать эти файлы в новый каталог.',
