...
$lang = array_merge($lang, array(
	...
	'FORUM_ICON_REPLACE'				=> 'Заменять иконку раздела',
	'FORUM_ICON_REPLACE_EXPLAIN'		=> 'Позволяет значку раздела заменять стандартную иконку.',
	...
	'FORUM_PRUNE_SHADOW_EXPLAIN'			=> 'Автоматическая очистка разделов от ссылок на темы, перенесённые в другие разделы. Задайте частоту автоочистки и возраст перенесённых тем ниже.',
	...
	'PRUNE_STICKY'				=> 'Очистить прикреплённые темы',
