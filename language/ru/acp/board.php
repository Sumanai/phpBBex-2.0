...
$lang = array_merge($lang, array(
	...
	'ALLOW_BIRTHDAYS_EXPLAIN'	=> 'Разрешить указывать дни рождения и отображения возраста в профиле. Учтите, что список дней рождения на странице списка разделов включается отдельно в настройках нагрузки на сервер.',
...
$lang = array_merge($lang, array(
	...
	'ONLINE_LENGTH_EXPLAIN'		=> 'Количество минут, по прошествии которых неактивные пользователи перестанут быть видимыми в списке «Кто сейчас на форуме». Увеличение этого значения повышает расход ресурсов сервера на создание списка.',
