...
$lang = array_merge($lang, array(
	...
	'BOARD_INDEX_TEXT_EXPLAIN'		=> 'Этот текст отображается как ссылка на главную страницу форума в меню навигации. По умолчанию будет отображен текст «Список разделов».',
	...
	'DISABLE_BOARD_EXPLAIN'			=> 'Форум станет недоступным для пользователей, не являющихся администраторами или модераторами. Также вы можете ввести короткое сообщение (до 255 символов), которое будут видеть посетители.',
	'DISPLAY_LAST_SUBJECT'			=> 'Показывать заголовок последнего сообщения в списке разделов',
	'DISPLAY_LAST_SUBJECT_EXPLAIN'	=> 'Заголовок последнего сообщения будет отображен в списке разделов в виде ссылки на данное сообщение. Заголовки сообщений, оставленных в разделах, защищённых паролем, либо право доступа к чтению которых у пользователя отсутствует, не будут показаны.',
	'GUEST_STYLE'					=> 'Стиль для гостей',
	'GUEST_STYLE_EXPLAIN'			=> 'Стиль форума для незарегистрированных пользователей.',
	...
	'SITE_HOME_TEXT_EXPLAIN'		=> 'Этот текст будет отображён в виде ссылки на основной сайт в меню навигации форума. По умолчанию будет отображен текст «Домой».',
	'SITE_HOME_URL'					=> 'Ссылка на основной сайт',
	'SITE_HOME_URL_EXPLAIN'			=> 'Если задано, данная ссылка будет добавлена в начало меню навигации форума, а также к логотипу форума. Ссылка должна быть абсолютной, например <samp>http://phpbbex.com</samp>.',
...
$lang = array_merge($lang, array(
	...
	'THROUGH_ANNOUNCE_EXPLAIN'			=> 'Разрешает отображать объявления из дочерних разделов в родительском.',
...
$lang = array_merge($lang, array(
	...
	'ALLOW_QUICK_REPLY_EXPLAIN'	=> 'При включении данной опции в необходимых разделах также должна быть включена опция быстрого ответа.',
	'ALLOW_QUICK_REPLY_BUTTON'	=> 'Отправить и включить быстрый ответ во всех разделах',
...
$lang = array_merge($lang, array(
	...
	'ALLOW_GRAVATAR'				=> 'Включить глобально распознаваемые аватары (Gravatar)',
	'ALLOW_LOCAL'					=> 'Включить галерею аватар',
	'ALLOW_REMOTE'					=> 'Разрешить отображение аватар по внешней ссылке',
	'ALLOW_REMOTE_EXPLAIN'			=> 'Не рекомендуется! Аватара будет отображаться напрямую с указанного адреса.',
	'ALLOW_REMOTE_UPLOAD'			=> 'Разрешить загрузку аватар по URL',
	'ALLOW_REMOTE_UPLOAD_EXPLAIN'	=> 'Изображение по ссылке будет скопировано на форум и пройдёт все проверки.',
	'ALLOW_UPLOAD'					=> 'Разрешить загрузку аватар с компьютера',
	'AVATAR_GALLERY_PATH'			=> 'Путь к галерее аватар',
	'AVATAR_GALLERY_PATH_EXPLAIN'	=> 'Путь к каталогу с загруженными в него рисунками относительно корневого каталога phpBBex. Например, <samp>images/avatars/gallery</samp>.<br />Сдвоенные точки <samp>../</samp> будут удалены из пути в целях безопасности.',
	'AVATAR_STORAGE_PATH'			=> 'Каталог для загрузки аватар',
	'AVATAR_STORAGE_PATH_EXPLAIN'	=> 'Путь к каталогу относительно корневого каталога phpBBex. Например, <samp>images/avatars/upload</samp>.<br />Загрузка аватар <strong>будет недоступна</strong>, если для данного каталога отсутствуют права на запись.<br />Сдвоенные точки <samp>../</samp> будут удалены из пути в целях безопасности.',
...
//	'ACC_USER_ADMIN'			=> 'User + Admin',
	...
	'USERNAME_ALPHA_ONLY'		=> 'Латинские буквы и цифры',
	...
	'USERNAME_CHARS_EXPLAIN'	=> 'Символы, которые могут быть использованы в именах пользователей. Разделителями считаются символы пробела, точки, -, и _',
...
// Cookie Settings
$lang = array_merge($lang, array(
	'ACP_COOKIE_SETTINGS_EXPLAIN'		=> 'Здесь вы можете изменить настройки cookies, отправляемые в браузеры посетителей. В большинстве случаев достаточно настроек по умолчанию. Если вам всё же нужно изменить настройки, то делайте это осторожно — неверные значения могут привести к невозможности входа пользователей на форум.',

	'COOKIE_DOMAIN'				=> 'Домен cookie',
	'COOKIE_NAME'				=> 'Имя cookie',
	'COOKIE_PATH'				=> 'Путь cookie',
	'COOKIE_SECURE'				=> 'HTTPS cookie',
	'COOKIE_SECURE_EXPLAIN'		=> 'Если ваш сервер работает через SSL, то включите этот параметр. В противном случае оставьте отключённым. Включение этого параметра, если сервер работает не через SSL, приведёт к серьёзным ошибкам.',
	'ONLINE_LENGTH'				=> 'Временной диапазон онлайн-статистики',
	'ONLINE_LENGTH_EXPLAIN'		=> 'Через указанное количество минут бездействия пользователи будут считаться неактивными. Увеличение этого значения повышает расход ресурсов сервера на создание списка.',
...
$lang = array_merge($lang, array(
	...
	'CONTACT_US_ENABLE_EXPLAIN'		=> 'Данная страница позволяет пользователям отправлять электронную почту администраторам форума',
...
// Load Settings
$lang = array_merge($lang, array(
	'ACP_LOAD_SETTINGS_EXPLAIN'	=> 'Здесь вы можете включать и отключать некоторые функции форума для снижения нагрузки на сервер. Для большинства серверов нет необходимости отключать какие-либо функции. Тем не менее на некоторых системах или коллективных хостингах может быть полезным отключение возможностей, которые вам не требуются. Вы можете также задать ограничения для нагрузки на сервер и активных сессий, при превышении которых форум будет отключена.',

	'ALLOW_CDN'						=> 'Разрешить использование CDN',
	'ALLOW_CDN_EXPLAIN'				=> 'Если включено, некоторые служебные файлы форума будут загружаться пользователями из сетей доставки контента (CDN) вместо вашего сервера. Это уменьшит расход трафика вашего сервера, но для некоторых администраторов может стать проблемой с точки зрения сохранения конфиденциальности. По умолчанию, включена загрузка «jQuery» и шрифта «Open Sans» из сети доставки контента Google.',
	'ALLOW_LIVE_SEARCHES'			=> 'Разрешить поиск «на лету»',
	'ALLOW_LIVE_SEARCHES_EXPLAIN'	=> 'Если разрешено, пользователям будут предлагаться варианты результатов поиска по мере набора ключевых слов в некоторых поисковых полях на форуме.',
	...
	'YES_ONLINE_EXPLAIN'			=> 'Отображать информацию об активных пользователях на главной странице, при просмотре разделов и тем.',
...
// Auth settings
$lang = array_merge($lang, array(
	'ACP_AUTH_SETTINGS_EXPLAIN'	=> 'phpBBex поддерживает расширения аутентификации, или модули. Они позволяют вам установить способ аутентификации пользователей при их входе на форум. По умолчанию доступны четыре модуля: DB, LDAP, Apache и OAuth. Не все методы требуют дополнительной информации, поэтому заполняйте только те поля, которые необходимы для выбранного метода.',
	...
	'AUTH_PROVIDER_OAUTH_EXPLAIN'				=> 'Каждый провайдер OAuth требует уникальную пару секретного кода и ключа для аутентификации с помощью внешнего сервера. Они должны быть предоставлены провайдером и ведены в точности в том виде, в котором были получены.<br />Любой сервис, не предоставляющий одновременно и ключ, и секретный код, будет недоступен для аутентификации пользователей форума. Учтите, что пользователь всё равно сможет зарегистрироваться и войти на форум через стандартный метод аутентификации (DB).',
...
$lang = array_merge($lang, array(
	...
	'MOD_REWRITE_INFORMATION_UNAVAILABLE' => 'Невозможно определить, поддерживается ли URL rewriting данным сервером. Данная функция может быть включена, однако, если URL rewriting не поддерживается, адреса на форуме (такие, как ссылки) могут отображаться неверно. Свяжитесь с провайдером веб-хостинга, если не уверены в том, безопасно ли включение данной функции.',
	'PATH_SETTINGS'				=> 'Параметры путей',
	'RANKS_PATH'				=> 'Путь к картинкам званий',
	'RANKS_PATH_EXPLAIN'		=> 'Путь относительно корневого каталога phpBBex. Например, <samp>images/ranks</samp>.',
	'SCRIPT_PATH'				=> 'Путь к форуму',
	'SCRIPT_PATH_EXPLAIN'		=> 'Путь к каталогу, содержащему phpBBex, относительно имени домена. Например, <samp>/phpBBex</samp>.',
	'SERVER_NAME'				=> 'Имя домена',
	'SERVER_NAME_EXPLAIN'		=> 'Имя домена, на котором работает форум. Например, <samp>www.example.com</samp>.',
	...
	'SMILIES_PATH_EXPLAIN'		=> 'Путь относительно корневого каталога phpBBex. Например, <samp>images/smilies</samp>.',
	'UPLOAD_ICONS_PATH'			=> 'Путь к значкам групп расширений',
	'UPLOAD_ICONS_PATH_EXPLAIN'	=> 'Путь относительно корневого каталога phpBBex. Например, <samp>images/upload_icons</samp>.',
	'USE_SYSTEM_CRON'		=> 'Выполнять периодические задачи через системный планировщик (cron)',
	'USE_SYSTEM_CRON_EXPLAIN'		=> 'Если отключено, phpBBex будет выполнять периодические задачи автоматически. Если включено, phpBBex не будет самостоятельно выполнять периодические задачи; вместо этого, системный администратор должен добавить выполнение <code>bin/phpbbcli.php cron:run</code> в системный планировщик (cron) для запуска с определённым интервалом (например, каждые 5 минут).',
));
...
$lang = array_merge($lang, array(
	...
	'ALLOW_AUTOLOGIN_EXPLAIN'		=> 'Опция определяет, разрешено ли пользователям использовать функцию «Запомнить меня» при посещении форума.',
	'ALLOW_PASSWORD_RESET'			=> 'Разрешить восстановление пароля («Забытый пароль»)',
	'ALLOW_PASSWORD_RESET_EXPLAIN'	=> 'Определяет, могут ли пользователи форума использовать ссылку «Забыли пароль?» на странице входа для восстановления доступа к своему аккаунту. Если используется внешний механизм аутентификации, может понадобиться отключить данную функцию.',
	'AUTOLOGIN_LENGTH'				=> 'Время действия автоматического входа при использовании функции «Запомнить меня» (дней)',
	'AUTOLOGIN_LENGTH_EXPLAIN'		=> 'Количество дней, по прошествии которых пользователь должен будет снова ввести свои имя и пароль для входа на форум, при использовании функции «Запомнить меня». Введите 0 для снятия ограничений.',
	...
	'PASS_TYPE_ALPHA'				=> 'Должен содержать латинские буквы и цифры',
	...
	'REFERRER_VALID'				=> 'Проверять реферер',
	'REFERRER_VALID_EXPLAIN'		=> 'Если включено, реферер для запросов типа POST будет проверен на параметры хоста/пути к скрипту. Это может вызвать проблемы с форумами, использующими несколько доменов или внешние аутентификации.',
