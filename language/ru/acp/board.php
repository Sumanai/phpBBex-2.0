...
$lang = array_merge($lang, array(
	...
	'ALLOW_CDN_EXPLAIN'				=> 'Если включено, некоторые служебные файлы форума будут загружаться пользователями из сетей доставки контента (CDN) вместо вашего сервера. Это уменьшит расход траффика вашего сервера, но для некоторых администраторов может стать проблемой с точки зрения сохранения конфиденциальности. По умолчанию, включена загрузка «jQuery» и шрифта «Open Sans» из сети доставки контента Google.',
