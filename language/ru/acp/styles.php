...
$lang = array_merge($lang, array(
	'ACP_STYLES_EXPLAIN'	=> 'Здесь вы можете управлять стилями, доступными на форуме. Вы можете изменять существующие стили, удалять, деактивировать, повторно активировать, устанавливать новые. Вы также можете увидеть, как будет выглядеть стиль, используя функцию предпросмотра. Также указано общее количество пользователей для каждого стиля. Учтите, что принудительная замена стилей пользователей здесь не производится.',
