...
$lang = array_merge($lang, array(
	...
	'ACP_LEGEND_EXT'			=> 'Дополнительные настройки от расширений',
...
$lang = array_merge($lang, array(
	...
	'RESET_DATE_SUCCESS'			=> 'Дата запуска форума успешно сброшена',
	'RESET_ONLINE'					=> 'Сброс рекорда посещаемости',
	'RESET_ONLINE_CONFIRM'			=> 'Вы действительно хотите сбросить рекорд посещаемости форума?',
	'RESET_ONLINE_SUCCESS'			=> 'Рекорд посещаемости форума успешно сброшен',
	...
	'RESYNC_RATES_SUCCESS'			=> 'Счётчики оценок успешно синхронизированы',
...
$lang = array_merge($lang, array(
	...
	'DONT_SEND_STATISTICS'		=> 'Переход на главную страницу панели администратора',
	'GO_ACP_MAIN'				=> 'Переход на главную страницу панели администратора',
...
$lang = array_merge($lang, array(
	...
	'LOG_UPDATE_PHPBB'		=> '<strong>Обновлён phpBBex с версии %1$s до версии %2$s</strong>',
...
$lang = array_merge($lang, array(
	...
	'LOGIN_VIA_EMAIL_ENABLE_EXPLAIN'	=> 'Разрешить пользователям входить в систему используя имя пользователя или e-mail. В скрытом режиме не будет индикации о возможности входа по e-mail. Внимание! В режиме входа только по e-mail необходима правка в стилях, не адаптированных для phpBBex!',
