...
$lang = array_merge($lang, array(
	...
	'ACP_SHORT'						=> 'Админка',
	'ACTIVE'						=> 'активен',
	'ACTIVE_ERROR'					=> 'Указанное имя пользователя в настоящее время неактивно. Если вы испытываете трудности с активацией своей учётной записи, то свяжитесь с администратором форума.',
	...
	'BAN_TRIGGERED_BY_EMAIL'=> 'Доступ к форуму закрыт для вашего адреса email.',
	'BAN_TRIGGERED_BY_IP'	=> 'Доступ к форуму закрыт для вашего IP-адреса.',
	'BAN_TRIGGERED_BY_USER'	=> 'Доступ к форуму закрыт для вашей учётной записи.',
	'BBCODE_GUIDE'			=> 'Руководство по BBCode',
	'BCC'					=> 'Скрытая копия',
	'BIRTHDAYS'				=> 'Дни рождения',
	'BOARD_BAN_PERM'		=> 'Вам закрыт доступ к форуму.<br /><br />Для получения дополнительной информации %2$sсвяжитесь с администратором форума%3$s.',
	'BOARD_BAN_REASON'		=> 'Причина: <strong>%s</strong>',
	'BOARD_BAN_TIME'		=> 'Вам закрыт доступ к форуму до <strong>%1$s</strong>.<br /><br />Для получения дополнительной информации %2$sсвяжитесь с администратором форума%3$s.',
	...
	'BROWSING_FORUM_GUESTS'	=> array(
		...
		2	=> 'Сейчас этот раздел просматривают: %2$s и %1$d гостя',
		3	=> 'Сейчас этот раздел просматривают: %2$s и %1$d гостей',
	),
	'BUTTON_EDIT'			=> 'Правка',
	...
	'FTP_FSOCK_ROOT_PATH_EXPLAIN'	=> 'Путь к каталогу, содержащей phpBBex, относительно корня сайта.',
	...
	'FTP_ROOT_PATH_EXPLAIN'		=> 'Путь к каталогу, содержащей phpBBex, относительно корня сайта.',
	...
	'GUEST_USERS_ONLINE'		=> array(
		0	=> 'Сейчас на форуме %d гостей',
		1	=> 'Сейчас на форуме %d гость',
		2	=> 'Сейчас на форуме %d гостя',
		3	=> 'Сейчас на форуме %d гостей',
	),
	...
	'POSTING_MESSAGE'		=> 'Размещение сообщения в разделе «%s»',
	...
	'POSTS_UNAPPROVED_FORUM'=> 'По крайней мере одно сообщение в этом разделе ожидает одобрения.',
	'POST_BY_AUTHOR'		=> '',
	...
	'READING_LINK'				=> 'Переход по ссылке «%s»',
	'READING_TOPIC'				=> 'Просмотр темы в разделе «%s»',
	...
	'REMOVE'					=> 'Удалить',
	'REMOVE_INSTALL'			=> 'Пожалуйста, удалите, переместите или переименуйте каталог install, прежде чем начнёте пользоваться форумом. В противном случае будет доступна только панель администратора.',
	'REPLIES'					=> 'Ответы',
	'REPLY_WITH_QUOTE'			=> 'Ответить с цитатой',
	'REPLYING_GLOBAL_ANNOUNCE'	=> 'Размещение ответа на важное объявление',
	'REPLYING_MESSAGE'			=> 'Размещение ответа в разделе «%s»',
	'REPORT_BY'					=> 'Источник',
	...
	'RETURN_TO_INDEX'			=> 'Вернуться к списку разделов',
	'FEED'						=> 'Канал',
	'FEED_NEWS'					=> 'Новости',
	...
	'TOTAL_POSTS_COUNT'	=> 'Всего сообщений: <strong>%d</strong>',
	'TOPIC_REPORTED'	=> 'На данную тему поступили жалобы',
	'TOTAL_TOPICS'		=> 'Всего тем: <strong>%d</strong>',
	'TOTAL_USERS'		=> 'Всего пользователей: <strong>%d</strong>',
	...
	'USER_NEW_PERMISSION_DISALLOWED'	=> 'Вам не разрешено использовать данную возможность. Возможно, вы недавно зарегистрировались на форуме или вам необходимо активнее участвовать в обсуждениях, чтобы получить такое право.',
	...
	'VIEWING_MCP'				=> 'Просмотр панели модератора',
	...
	'VIEWING_UCP'				=> 'Просмотр личной панели управления',
	'VIEWS'						=> 'Просмотры',
