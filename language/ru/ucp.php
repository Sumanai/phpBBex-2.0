...
$lang = array_merge($lang, array(
	...
	'AVATAR_DRIVER_LOCAL_EXPLAIN'	=> 'Вы можете выбрать аватару из числа доступных в галерее на данном форуме.',
	...
	'AVATAR_EXPLAIN'				=> 'Допустимые параметры: ширина не более %1$s, высота не более %2$s, размер файла не более %3$.2f КБ. Допустимые форматы файлов: JPG, PNG, GIF.',
	...
	'FIELD_INVALID_CHARS_ALPHA_DOTS'	=> 'Поле «%s» содержит недопустимые символы, разрешены только латинские буквы, цифры и точка (.).',
	'FIELD_INVALID_CHARS_ALPHA_ONLY'	=> 'Поле «%s» содержит недопустимые символы, разрешены только латинские буквы и цифры.',
	'FIELD_INVALID_CHARS_ALPHA_PUNCTUATION'	=> 'Поле «%s» содержит недопустимые символы, разрешены только латинские буквы, цифры, знаки препинания _,-. и первый символ должен быть латинской буквой.',
	'FIELD_INVALID_CHARS_ALPHA_SPACERS'	=> 'Поле «%s» содержит недопустимые символы, разрешены только латинские буквы, цифры, пробел и разделители -+_[].',
	'FIELD_INVALID_CHARS_ALPHA_UNDERSCORE'	=> 'Поле «%s» содержит недопустимые символы, разрешены только латинские буквы, цифры и подчёркивание.',
	'FIELD_INVALID_CHARS_LETTER_NUM_DOTS'	=> 'Поле «%s» содержит недопустимые символы, разрешены только буквы, цифры и точка (.).',
	'FIELD_INVALID_CHARS_LETTER_NUM_ONLY'	=> 'Поле «%s» содержит недопустимые символы, разрешены только буквы и цифры.',
	'FIELD_INVALID_CHARS_LETTER_NUM_PUNCTUATION'	=> 'Поле «%s» содержит недопустимые символы, разрешены только буквы, цифры, знаки препинания _,-. и первый символ должен быть буквой.',
	'FIELD_INVALID_CHARS_LETTER_NUM_SPACERS'		=> 'Поле «%s» содержит недопустимые символы, разрешены только буквы, цифры, пробел и разделители -+_[].',
	'FIELD_INVALID_CHARS_LETTER_NUM_UNDERSCORE'		=> 'Поле «%s» содержит недопустимые символы, разрешены только буквы, цифры и подчёркивание.',
	...
	'LOGIN_LINK_NO_DATA_PROVIDED'	=> 'Не были предоставлены данные для привязки учётной записи внешнего сервиса к учётной записи форума. Свяжитесь с администратором форума, если проблема не исчезнет.',
	...
	'MOVE_PM_ERROR'					=> 'Во время перемещения сообщений в новую папку произошла ошибка, перенесено сообщений: %2$d из %1$s.',
	...
	'NO_WATCHED_SELECTED'		=> 'Вы не выбрали какие-либо темы или разделы, на которые подписаны.',
	...
	'UCP_AUTH_LINK_NOT_SUPPORTED'	=> 'Привязка учётных записей форума к внешним сервисам не поддерживается текущим механизмом авторизации.',
	...
	'USERNAME_ASCII_EXPLAIN'		=> 'От %1$d до %2$d знаков, только символы ASCII, без специальных символов.',
