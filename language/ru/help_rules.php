...
$help = array(
	...
	array(
		0 => '1.2. Общие правила',
		1 => 'Запрещается публиковать информацию, содержащую: <ol><li>чрезмерное количество жаргонных слов, грубые и нецензурные слова или выражения;</li><li>рекламу;</li><li>порнографию;</li><li>чужую личную информацию;</li><li>оскорбления, угрозы, клевету;</li><li>объекты расистского характера и разжигания межнациональной розни;</li><li>политическую, религиозную и иную пропаганду;</li><li>призывы к насилию или нарушению действующего законодательства.</li></ol>Наказание: правка или удаление информации, а также предупреждение или бан пользователя.'
	),
	array(
		0 => '--',
