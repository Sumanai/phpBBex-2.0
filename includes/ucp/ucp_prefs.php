		...
		switch ($mode)
		{
			...
			case 'view':
				...
				*/
				...
				$sort_by_topic_sql = array('t' => array('t.topic_last_post_time', 'c' => 't.topic_time', 'r' => 't.topic_posts_approved', 'v' => 't.topic_views', 'a' => 't.topic_first_poster_name', 't.topic_last_post_id'), 's' => 't.topic_title');
