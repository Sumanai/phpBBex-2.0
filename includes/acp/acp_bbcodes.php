			...
			case 'create':
				...
				*/
				...
				if (!$warn_text || confirm_box(true))
				{
					...
					$hard_coded = array('code', 'quote', 'quote=', 'spoiler', 'spoiler=', 'attachment', 'attachment=', 'b', 'i', 's', 'url', 'url=', 'img', 'size', 'size=', 'color', 'color=', 'u', 'list', 'list=', 'email', 'email=', 'flash', 'flash=', 'upd=');
		...
		*/
		...
		while ($row = $db->sql_fetchrow($result))
		{
			$bbcodes_array = array(
				...
				'U_MOVE_UP'		=> $u_action . '&amp;action=move_up&amp;order=' . $row['bbcode_order'],
				'U_MOVE_DOWN'	=> $u_action . '&amp;action=move_down&amp;order=' . $row['bbcode_order'],
			);
