...
$sort_by_sql = array('t' => array('p.post_time', 'p.post_id'), 'a' => array('u.username_clean', 'p.post_id'), 's' => array('p.post_subject', 'p.post_id'));
...
$page_title = $topic_data['topic_title'] . ' - ' . $topic_data['forum_name'] . ($start ? ' - ' . $pagination->on_page($total_posts, $config['posts_per_page'], $start) : '');
