...
* Locations:
    ...
    + styles/prosilver_ex/template/attachment.html
* Since: 3.1.6-RC1
...
* Locations:
    ...
    + styles/prosilver_ex/template/forumlist_body.html
* Since: 3.1.0-a4
...
* Locations:
    ...
    + styles/prosilver_ex/template/index_body.html
* Since: 3.1.0-b3
...
* Locations:
    ...
    + styles/prosilver_ex/template/mcp_ban.html
* Since: 3.1.0-RC3
...
* Locations:
    ...
    + styles/prosilver_ex/template/mcp_forum.html
* Since: 3.1.6-RC1
...
* Locations:
    ...
    + styles/prosilver_ex/template/mcp_front.html
* Since: 3.1.3-RC1
...
* Locations:
    ...
    + styles/prosilver_ex/template/mcp_post.html
* Since: 3.1.5-RC1
...
* Locations:
    ...
    + styles/prosilver_ex/template/mcp_topic.html
* Since: 3.1.6-RC1
...
* Locations:
    ...
    + styles/prosilver_ex/template/mcp_warn_post.html
* Since: 3.1.0-RC4
...
* Locations:
    ...
    + styles/prosilver_ex/template/mcp_warn_user.html
* Since: 3.1.0-RC4
...
* Locations:
    ...
    + styles/prosilver_ex/template/memberlist_body.html
* Since: 3.1.6-RC1
...
* Locations:
    ...
    + styles/prosilver_ex/template/memberlist_search.html
* Since: 3.1.2-RC1
...
* Locations:
    ...
    + styles/prosilver_ex/template/overall_footer.html
* Since: 3.1.0-a1
...
* Locations:
    ...
    + styles/prosilver_ex/template/navbar_footer.html
* Since: 3.1.0-a1
...
* Locations:
    ...
    + styles/prosilver_ex/template/overall_header.html
* Since: 3.1.0-b2
* Purpose: Add content to the header body
...
* Locations:
    + styles/prosilver/template/navbar_header.html
    + styles/prosilver_ex/template/header_path.html
* Since: 3.1.0-a1
...
* Locations:
    ...
    + styles/prosilver_ex/template/posting_editor.html
* Since: 3.1.6-RC1
...
* Locations:
    ...
    + styles/prosilver_ex/template/posting_buttons.html
* Since: 3.1.0-a3
...
* Locations:
    ...
    + styles/prosilver_ex/template/posting_pm_header.html
* Since: 3.1.0-RC4
...
* Locations:
    ...
    + styles/prosilver_ex/template/posting_pm_layout.html
* Since: 3.1.4-RC1
...
* Locations:
    ...
    + styles/prosilver_ex/template/posting_poll_body.html
* Since: 3.1.4-RC1
...
* Locations:
    ...
    + styles/prosilver_ex/template/posting_preview.html
* Since: 3.1.7-RC1
...
* Locations:
    ...
    + styles/prosilver_ex/template/quickreply_editor.html
* Since: 3.1.0-b2
...
* Locations:
    ...
    + styles/prosilver_ex/template/search_body.html
* Since: 3.1.7-RC1
...
* Locations:
    ...
    + styles/prosilver_ex/template/search_results.html
* Since: 3.1.4-RC1
...
* Locations:
    ...
    + styles/prosilver_ex/template/simple_footer.html
* Since: 3.1.0-a1
...
* Locations:
    ...
    + styles/prosilver_ex/template/simple_header.html
* Since: 3.1.0-b2
* Purpose: Add content to the header body
...
* Locations:
    ...
    + styles/prosilver/template/mcp_forum.html
    + styles/prosilver_ex/template/search_results.html
    + styles/prosilver_ex/template/viewforum_body.html
    + styles/prosilver_ex/template/mcp_forum.html
    + styles/prosilver_ex/template/index_body.html
* Since: 3.1.0-a1
...
* Locations:
    ...
    + styles/prosilver_ex/template/ucp_agreement.html
* Since: 3.1.0-b3
...
* Locations:
    ...
    + styles/prosilver_ex/template/ucp_main_front.html
* Since: 3.1.6-RC1
...
* Locations:
    ...
    + styles/prosilver_ex/template/ucp_pm_history.html
* Since: 3.1.6-RC1
...
* Locations:
    ...
    + styles/prosilver_ex/template/ucp_pm_viewmessage.html
* Since: 3.1.0-RC3
...
* Locations:
    ...
    + styles/prosilver_ex/template/ucp_pm_viewmessage_print.html
* Since: 3.1.0-a1
...
* Locations:
    ...
    + styles/prosilver_ex/template/ucp_prefs_personal.html
* Since: 3.1.0-a1
...
* Locations:
    ...
    + styles/prosilver_ex/template/ucp_prefs_post.html
* Since: 3.1.0-a1
...
* Locations:
    ...
    + styles/prosilver_ex/template/ucp_prefs_view.html
* Since: 3.1.0-a1
...
* Locations:
    ...
    + styles/prosilver_ex/template/ucp_profile_profile_info.html
* Since: 3.1.4-RC1
...
* Locations:
    ...
    + styles/prosilver_ex/template/ucp_profile_reg_details.html
* Since: 3.1.4-RC1
...
* Locations:
    ...
    + styles/prosilver_ex/template/ucp_register.html
* Since: 3.1.0-b5
...
* Locations:
    ...
    + styles/prosilver_ex/template/ucp_zebra_friends.html
* Since: 3.1.0-a4
...
* Locations:
    ...
    + styles/prosilver_ex/template/viewtopic_print.html
* Since: 3.1.0-a1
...
* Locations:
    ...
    + styles/prosilver_ex/template/viewtopic_topic_tools.html
* Since: 3.1.0-a3
