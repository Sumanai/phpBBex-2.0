...
$lang = array_merge($lang, array(
	...
	'SRT_NO_CACHE'					=> 'Генератор формы запроса использует проверку системных файлов phpBBex. Ваша версия phpBBex не соответствует данной версии генератора. Воспользуйтесь генератором формы запроса на форуме phpBB. <a href="http://www.phpbb.com/support/srt/">online SRT Generator</a>',
...
//	'STEP1_CONVERT_EXPLAIN'	=> '',
	...
	'STEP1_HACKED'			=> 'Был ли ваш форум взломан?',
	'STEP1_HACKED_EXPLAIN'	=> 'Выберите "Да" если вам требуется поддержка, так как ваш форум был повреждён, иначе вы поставите нас под угрозу.',
	'STEP1_HACKED_ERROR'	=> 'Если ваш форум был взломан, подайте отчет о расследование инцидента вместо обращения на форум поддержки, для того, чтобы никакая конфиденциальная информация не была доступна третьим лицам.<br /><br />Смотрите <a href="http://www.phpbb.com/incidents/"><b>здесь</b></a> как это сделать.',
));
...
$lang = array_merge($lang, array(
	'SRT_QUESTIONS'			=> array(
		'step2'	=> array(
			'phpbb_version'		=> 'Какую версию phpBBex вы используете?',
			'board_url'			=> 'Ссылка на ваш форум?',
			...
			'install_type'		=> 'Как вы установили ваш форум?',
		...
		'step3'	=> array(
			...
			'installed_languages'	=> 'Какие языковые пакеты установлены на вашем форуме?',
...
$lang = array_merge($lang, array(
	'SRT_QUESTIONS_EXPLAIN'	=> array(
		'step2'	=> array(
			'phpbb_version'		=> 'SRT Generator не может определить, какую версию phpBBex вы используете, поэтому правильно укажите версию. Чтобы получить эту информацию, зайдите на свой форум, перейдите вниз страницы и кликните по ссылке "Панель администратора", затем перейдите на вкладку "Система" и перейдите по ссылке "Сведения о PHP"',
			'board_url'			=> 'URL форума - это адрес, который вы используете для доступа к вашему форуму. Большинство проблем легче исправить, если можно получить доступ к вашему форуму. Если вы не хотите сообщать эту информацию, введите "n/a".',
			'dbms'				=> 'Чтобы определить, какой тип базы данных и ее версию вы используете, перейдите в Панель администратора. На вкладке "Общие" обратите внимание на строку "Сервер базы данных:".',
			'php'				=> 'Чтобы определить, какую версию PHP вы используете, перейдите в Панель администратора. На вкладке "Система" перейдите по ссылке "Сведения о PHP"',
			'host_name'			=> 'Некоторые проблемы, возникшие с форумами phpBBex, могут возникнуть у конкретных хостеров. Укажите в этом поле название компании, которая предоставляет веб-хостинг (например, GoDaddy, Yahoo!, TimeWeb, и т.д.). Если форум установлен на вашем собственном сервере, укажите это. Если вы не знаете, кто является хостером вашего форума, также укажите это.',
			'install_type'		=> 'Если вы установили свой форум, загрузив файлы phpBBex на сервер, и затем, запустив скрипт установки, выберите один из вариантов "Я использовал..." Если кто-то другой установил ваш форум, выберите "Кто-то другой установил форум на мой сайт." Если вы использовали автоматизированное средство установки, выберите "Я использовал инструмент, предоставляемый моим хостером."',
			'inst_converse'		=> 'Чистая установка означает, что ваш форум не существовала до установки phpBBex. Если вы недавно обновили форум с более старой версии phpBB или phpBBex до появления проблемы, выберите "Обновление с более ранней версии phpBB или phpBBex". Конвертация означает, что ваш форум ранее работал под управлением другого программного обеспечения, которое было позже сконвертировано в phpBBex.',
			'mods_installed'	=> 'Расширения часто являются причиной многих проблем, связанных с phpBBex. Эта информация может помочь определить точную причину вашей проблемы.',
			'registration_req'	=> 'Выберите "Да", если для того, чтобы увидеть вашу проблему, нужно войти на форум как зарегистрированный пользователь.',
		),
		'step3'	=> array(
			'installed_styles'		=> 'Устаревший стиль является причиной многих проблем. Если вы не знаете, какие стили у вас установлены, перейдите в Панель администратора, затем перейдите к вкладке «Персонализация» --> "Управление стилями" и перейдите по ссылке "Стили".',
			'installed_languages'	=> 'Устаревший языковой пакет является причиной многих проблем. Если вы не знаете, какие языковые пакеты у вас установлены, перейдите в Панель администратора, затем перейдите к вкладке «Персонализация» --> "Языки" и перейдите по ссылке "Языковые пакеты".',
...
$lang = array_merge($lang, array(
	'SRT_DROPDOWN_OPTIONS'	=> array(
		'step2'	=> array(
			'install_type'	=> array(
				null			=> 'Выберите ответ',
				'myself'		=> 'Я использовал установочный пакет с phpbbex.com',
				'repo'			=> 'Я использовал установку из репозитория',
				'third'			=> 'Я использовал установочный пакет с другого сайта',
				'someone_else'	=> 'Кто-то другой установил форум на мой сайт',
				'automated'		=> 'Я использовал инструмент, предоставляемый моим хостером',
			),
			'inst_converse'	=> array(
				null				=> 'Выберите ответ',
				'fresh'				=> 'Чистая установка',
				'phpbb_update'		=> 'Обновление с более ранней версии phpBB или phpBBex',
		...
		'step3'	=> array(
			'xp_level'		=> array(
				null			=> 'Выберите ответ',
				'new_both'		=> 'Новичок в PHP и phpBBex',
				'new_phpbb'		=> 'Новичок в phpBBex, но не в PHP',
				'new_php'		=> 'Новичок в PHP, но не в phpBBex',
				'comfort'		=> 'Достаточно опытный пользователь PHP и phpBBex',
				'experienced'	=> 'Опытный пользователь PHP и phpBBex',
			),
		),
	),
));
