...
$lang = array_merge($lang, array(
	...
	'MERGE_USERS_EXPLAIN'					=> 'Инструмент объединит права доступа и все темы с сообщениями с одной пользовательской учётной записи в другую (установки исходного пользователя и его членство в группах - остаются). Переносятся (добавляются) права доступа, вложения, блокировки, закладки, черновики, записи о просмотрах разделов/тем, история посещений, голосование, сообщения, личные сообщения, жалобы, темы, предупреждения, записи о друзьях и недругах.',
	...
	'MERGE_USERS_REMOVE_SOURCE_EXPLAIN'		=> 'Если отмечено, инструмент удалит исходного пользователя с форума.',
