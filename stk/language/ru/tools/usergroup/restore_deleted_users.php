...
$lang = array_merge($lang, array(
	...
	'RESTORE_DELETED_USERS_CONFLICT_EXPLAIN'	=> 'Этот инструмент позволяет вам восстановить (создать) удалённых пользователей, если оставлены их сообщения, как "гостевые".<br />Данным пользователям будут назначены случайные пароли, которые вы должны изменить вручную после окончания работы инструмента. Данный инструмент не предлагает список сгенерированных паролей для каждого пользователя!<br /><br />Во время последнего исполнения инструмент обнаружил, что некоторые имена уже используются на форуме. Пожалуйста предложите новые имена для пользователей.',
	'RESTORE_DELETED_USERS_EXPLAIN'				=> 'Этот инструмент позволяет вам восстановить (создать) удалённых пользователей, если оставлены их сообщения, как "гостевые".<br />Внимание! Выведенный список имен не является списком зарегистрированных на форуме пользователей! Этот список создан из имен, введенных в графе "Автор сообщения" гостями или в формах личных сообщений, если на форуме разрешено отправлять личные сообщения (заменяя свои настоящие имена на любые, не соответствующие действительным).',
