...
$lang = array_merge($lang, array(
	...
	'ORPHANED_FORUM_POSTS'			=> 'Сообщения не приписанные к разделам',
	'ORPHANED_FORUM_POSTS_EXPLAIN'	=> 'Эти сообщения не привязаны к конкретным разделам, поэтому считается, что они также не привязаны к конкретным темам. Укажите ID темы-родителя, к которой необходимо привязать эти сообщения.',
	'NO_FORUM_ORPHANED_POSTS'		=> 'Сообщения не приписанные к разделам не найдены',
