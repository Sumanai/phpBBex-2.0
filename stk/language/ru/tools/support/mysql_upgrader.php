...
$lang = array_merge($lang, array(
	...
	'MYSQL_UPGRADER_EXPLAIN'			=> 'Этот инструмент предназначен для решения проблем, которые возникают из-за несовместимости версии MySQL с вашей версией phpBBex, а также после обновления версии MySQL на более новую. Инструмент укажет на несовместимые таблицы Базы Данных с версией phpBBex <em> Смотрите также “<a href="http://www.phpbb.com/kb/article/doesnt-have-a-default-value-errors" target="_blank" />Есть\нет ошибки</a>” в таблицах Базы Данных.</em>',
