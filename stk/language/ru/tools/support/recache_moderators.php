...
$lang = array_merge($lang, array(
	...
	'RECACHE_MODERATORS_CONFIRM'		=> '(<em>Информация о назначении модераторов на разделы и отображении их на главной странице)</em><br /><br />Вы уверены, что хотите пересоздать кеш модераторов?',
));
