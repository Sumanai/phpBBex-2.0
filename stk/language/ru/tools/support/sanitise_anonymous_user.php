...
$lang = array_merge($lang, array(
	...
	'ANONYMOUS_GROUPS_REMOVED'			=> 'Учётная запись Гостя успешно удалена из всех групп форума.',
	'ANONYMOUS_MISSING'					=> 'Учётная запись Гостя повреждена.',
	'ANONYMOUS_MISSING_CONFIRM'			=> 'Учётная запись Гостя в вашей базе данных повреждена. Данный аккаунт используется для организации гостевого доступа на форум. Вы хотите создать её?',
