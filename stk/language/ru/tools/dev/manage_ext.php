...
$lang = array_merge($lang, array(
	...
	'EXTENSIONS_FILES_EXPLAIN'	=> 'Здесь вы можете просмотреть, переименовать, удалить или создать новые файлы или каталоги в ваших расширениях.',
	...
	'FAIL_CREATE_DIR'			=> 'Не удалось создать каталог %s',
	'ADD_NEW'					=> 'Добавить новый файл',
	'PATH'						=> 'Путь, относительно каталога %s/',
	'PATH_EXPLAIN'				=> 'Если каталог не существует, он будет создан',
	'FILE'						=> 'Имя файла',
	'CONTENT'					=> 'Код',
	'EXT_PATH'					=> 'Путь относительно каталога ' . PHPBB_ROOT_PATH . 'ext/',
	'DELETE'					=> 'Удалить',
	'RENAME'					=> 'Переименовать',
	'DELETE_OK'					=> 'Файл %s был успешно удален',
	'DELETE_FAIL'				=> 'Не удалось удалить файл %s',
	'DELETE_FOLDER_OK'			=> 'Каталог %s была успешно удалена',
	'DELETE_FOLDER_FAIL'		=> 'Не удалось удалить каталог %s',
	'NEW_NAME'					=> 'Новое имя',
	'RENAME_OK'					=> 'Файл %1s был успешно переименован в %2s',
	'RENAME_FAIL'				=> 'Не удалось переименовать файл %s',
	'RENAME_FOLDER_OK'			=> 'Каталог %1s была успешно переименована в %2s',
	'RENAME_FOLDER_FAIL'		=> 'Не удалось переименовать каталог %s',
