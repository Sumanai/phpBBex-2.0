...
$lang = array_merge($lang, array(
	...
	'DEVELOPER_EXPLAIN'		=> 'Это имя разработчика расширения, которое будет отображаться в Панели администратора во вкладке <strong>&laquo;Персонализация-->Управление расширениями-->Информация о расширении&raquo;</strong> вместе с остальными дополнительными параметрами, которые вы можете ввести ниже.',
	'AUTHOR_EXPLAIN'		=> 'Имя вендора.<br />В каталоге ./ext/ будет создана каталог (если таковой еще не существует) с именем, совпадающим с этим параметром. Все расширения этого автора должны находиться внутри этого каталога. В названиях каталогов не допускаются тире и знаки подчёркивания. В имени вендора должно быть не менее 3-х символов.',
	'EXT_EXPLAIN'			=> 'Название расширения.<br />В каталоге ./ext/_имя_вендора_/ будет создана каталог с именем, совпадающим с этим параметром. Все каталоги и файлы данного расширения будут располагаться внутри этого каталога. В названии расширения должно быть не менее 3-х символов.',
