...
$lang = array_merge($lang, array(
	...
	'RESYNC_AVATARS_CONFIRM'	=> 'Данный инструмент проверяет существование на сервере файлов аватар, использумых на форуме (<em>файлы из галерей аватар не проверяются</em>). Если будет обнаружено, что файл отсутствует, аватар будет удален из профиля пользователя. Продолжить?',
