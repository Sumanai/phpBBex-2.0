...
$lang = array_merge($lang, array(
	...
	'DB_BACKUP_EXPLAIN'			=> 'Здесь вы можете создать резервную копию таблиц базы данных форума. Вы можете сохранить конечный архив на сервере в каталоге store/ , скачать его или вывести текст на дисплей. В зависимости от конфигурации сервера может быть доступно сжатие файла резервной копии в нескольких форматах.',
