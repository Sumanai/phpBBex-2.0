...
$lang = array_merge($lang, array(
	...
	'INCORRECT_PHPBB_VERSION'			=> 'Ваша версия phpBBex несовместима с данным STK. Убедитесь, что вы используете версию phpBBex.',
	...
	'REQUEST_PHPBB_VERSION'				=> 'Определение версии phpBBex',
	'REQUEST_PHPBB_VERSION_EXPLAIN'		=> 'Инструментарий поддержки не смог определить версию вашего форума, пожалуйста выберите ее из представленного списка.<br />Посетите <a href="http://www.phpbbguru.net/community/forum47.html">форум поддержки</a> чтобы получить конкретную помощь в решении данной проблемы.',
	...
	'CLOSE'								=> 'Закрыть',
	'UPDATES_AVAILABLE'					=> 'Ваша версия phpBBex не самая последняя. Доступная для обновления версия %1$s<br />Перейдите по этой ссылке <a href="%2$s" target="_blank" />%2$s</a> на объявление о выпуске последней версии,<br />которое содержит дополнительную информацию, а также инструкции по обновлению phpBBex',
