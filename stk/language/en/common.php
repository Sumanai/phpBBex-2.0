...
$lang = array_merge($lang, array(
	...
	'CAT_DEV_EXPLAIN'					=> 'Developer Tools may be used by phpBBex Developers and MODders to perform common tasks.',
	'CAT_ERK'							=> 'Emergency Repair Kit',
	'CAT_ERK_EXPLAIN'					=> 'The emergency repair kit is a seperate package of the STK that is build to run some checks that can detect issues within your phpBBex install that might prevent your board from working. Click <a href="%s">here</a> to run the ERK.',
	'CAT_MAIN'							=> 'Main',
	'CAT_MAIN_EXPLAIN'					=> 'The Support Toolkit (STK) may be used to fix common issues within a working installation of phpBBex 2.x.x. It serves as a second Administration Control Panel, providing an administrator with a set of tools to resolve common problems that may prevent a phpBBex installation from functioning properly.',
	'CAT_SUPPORT'						=> 'Support Tools',
	'CAT_SUPPORT_EXPLAIN'				=> 'Support Tools may be used to aid in the recovery of a phpBBex 2.x.x installation that is no longer functioning properly.',
	'CAT_USERGROUP'						=> 'User/Group Tools',
	'CAT_USERGROUP_EXPLAIN'				=> 'User and Group Tools may be used to manage users and groups in ways that are not available in a stock phpBBex 2.x.x installation.',
	...
	'GEN_PASS_FILE_EXPLAIN'				=> 'If you aren’t able to login to phpBBex you can use the internal authentication method of the Support Toolkit. To use this method you must <a href="%s"><strong>generate</strong></a> a new password file.',
	...
	'INCORRECT_PHPBBEX_VERSION'			=> 'Your version of phpBBex isn’t compatible with this tool. Your phpBBex installation must be version %1$s or later in order to run this tool.',
	...
	'PLUGIN_INCOMPATIBLE_PHPBB_VERSION'	=> 'This tool isn’t compatible with the version of phpBBex that you are running',
	...
	'STK_OUTDATED'						=> 'Your Support Toolkit installation appears to be out of date. The latest available version is <strong style="color: #008000;">%1$s</strong>, while the version your have installed is <strong style="color: #FF0000;">%2$s</strong>.<br /><br />Due to the large impact of this tool on your phpBBex installation, it has been disabled until an update is performed. We strongly recommend keeping all software running on your server up to date. For more information regarding the latest update, please see the <a href="%3$s">release topic</a>.<br /><br /><em>If you see this notice after an update of the Support Toolkit, click <a href="%4$s">here</a> to clear the version check cache.</em>',
	'SUPPORT_TOOL_KIT'					=> 'Support Toolkit',
	'SUPPORT_TOOL_KIT_INDEX'			=> 'Support Toolkit Index',
	'SUPPORT_TOOL_KIT_PASSWORD'			=> 'Password',
	'SUPPORT_TOOL_KIT_PASSWORD_EXPLAIN'	=> 'Since you are not logged in to phpBBex you must verify that you are a board founder by entering the Support Toolkit Password.<br /><br /><strong>Cookies MUST be allowed by your browser or you will not be able to stay logged in.</strong>',
	...
	'USING_STK_LOGIN'					=> 'You are logged in using the internal STK authentication method. It is advised to use this method <strong>only</strong> when you are unable to login to phpBBex.<br />To disable this authentication method click <a href="%1$s">here</a>.',
	'VISITED'							=> 'Last visit',
	'TOTAL'								=> 'Total',

	'ERK_OK'							=> 'The Emergency Repair Kit hasn\'t found any critical issues within your phpBBex installation.',
	...
	'STK_FATAL_ERROR'					=> '<strong style="color: #ff0000;">The Support Toolkit encountered a fatal error.</strong><br /><br />
											The Support Toolkit includes an Emergency Repair Kit (ERK), a tool designed to resolve certain errors that prevent phpBBex from functioning.
	...
	'CONFIG_REPAIR_NO_TABLES'			=> 'phpBBex tables could not be found on this database with this table prefix.',
	...
	'CLOSE'								=> 'Close',
	'UPDATES_AVAILABLE'					=> 'Your version of phpBBex is not the latest. Available version for updates is %1$s<br />Follow this link <a href="%2$s" target="_blank" />%2$s</a> to the release announcement for the latest version, which contains additional information, as well as instructions for updating phpBBex',
	'VERSIONCHECK_FAIL'					=> 'Failed to obtain latest phpBBex version information.',
