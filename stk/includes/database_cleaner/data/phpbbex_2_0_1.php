...
/**
* phpBBex 2.0.1 data file
*/
class datafile_phpbbex_2_0_1
{
	/**
	* @var Array The bots
	*/
	var $bots = array(
		// No changes phpBBex 2.0.0 -> phpBBex 2.0.1
	);

	/**
	* @var Array phpBBex 2.0.1 config data
	*/
	var $config = array(
		'active_topics_on_index_exclude'		=> array('config_value' => '0', 'is_dynamic' => '0'),

		// Version
		'phpbbex_version'						=> array('config_value' => '2.0.1', 'is_dynamic' => '0'),
