...
/**
* phpBBex 2.0.4 data file
*/
class datafile_phpbbex_2_0_4
{
	/**
	* @var Array The bots
	*/
	var $bots = array(
		// No changes phpBBex 2.0.3 -> phpBBex 2.0.4
	);

	/**
	* @var Array phpBBex 2.0.4 config data
	*/
	var $config = array(
		'style_forum_image_opacity'	=> array('config_value' => '0.6', 'is_dynamic' => '0'),

		// Version
		'phpbbex_version'			=> array('config_value' => '2.0.4', 'is_dynamic' => '0'),
	);

	/**
	* @var Array Config entries that were removed by the phpBBex 2.0.3 update
	*/
	...
	*/
	function get_schema_struct(&$schema_data)
	{
		...
		$schema_data['phpbb_topics']['COLUMNS']['topic_priority'] = array('INT:8', 0, 'after' => 'topic_type');
	}
}
