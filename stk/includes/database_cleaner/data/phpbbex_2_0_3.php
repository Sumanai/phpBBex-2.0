...
/**
* phpBBex 2.0.3 data file
*/
class datafile_phpbbex_2_0_3
{
	/**
	* @var Array The bots
	*/
	var $bots = array(
		// No changes phpBBex 2.0.2 -> phpBBex 2.0.3
	);

	/**
	* @var Array phpBBex 2.0.3 config data
	*/
	var $config = array(
		// Add new annoucements comfigs
		'global_announce_on_index'				=> array('config_value' => '1', 'is_dynamic' => '0'),
		'global_announce_in_all_forums'			=> array('config_value' => '1', 'is_dynamic' => '0'),
		'simple_announce_on_index'				=> array('config_value' => '0', 'is_dynamic' => '0'),
		'through_announce'						=> array('config_value' => '1', 'is_dynamic' => '0'),

		// Version
		'phpbbex_version'						=> array('config_value' => '2.0.3', 'is_dynamic' => '0'),
	);

	/**
	* @var Array Config entries that were removed by the phpBBex 2.0.2 update
	*/
