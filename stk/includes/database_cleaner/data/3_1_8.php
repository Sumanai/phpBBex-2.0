...
class datafile_3_1_8
{
	...
	*/
	var $removed_config = array(
		// No config entries removed 3.1.7 -> 3.1.8
	);
	...
	*/
	var $acl_options = array(
		// No permission changes 3.1.7 -> 3.1.8
	);
	...
	*/
	var $acl_role_data = array(
		// No role data changes 3.1.7 -> 3.1.8
	);
	...
	*/
	var $extension_groups = array(
		// No extension group changes 3.1.7 -> 3.1.8
	);
	...
	*/
	var $extensions = array(
		// No extension changes 3.1.7 -> 3.1.8
	);
	...
	*/
	var $module_categories = array(
		// No Module categories changes 3.1.7 -> 3.1.8
	);

	var $module_extras = array(
		// No Module extra changes 3.1.7 -> 3.1.8
	);

	var $module_categories_basenames = array(
		// No Categories basenames changes 3.1.7 -> 3.1.8
	);
	...
	*/
	var $groups = array(
		// No Group changes 3.1.7 -> 3.1.8
	);
	/**
	* @var Array All default report reasons
	*/
	var $report_reasons = array(
		// No reason changes 3.1.7 -> 3.1.8
	);

	var $acp_modules = array(
		// No ACP modules changes 3.1.7 -> 3.1.8
	);
